<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventarioEntrada.aspx.cs" Inherits="Eisum.InventarioEntrada" %>
...
<html>
	<head>
		<title>Eisum | Entrada Inventario</title>
		<meta charset="utf-8" />
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<!-- Header -->
								<header id="header">
									<a class="logo"><strong><asp:Label runat ="server" ID ="lblTitulo" Text="Ingreso de Insumos Almacén Principal"></asp:Label></strong></a>
								</header>
							<!-- Content -->
										...
										<div class="row uniform">
											<div class="6u 12u$(xsmall)">
												<div class="select-wrapper">
													<asp:DropDownList ID="ddAlmacen" runat="server" AppendDataBoundItems="true" AutoPostBack = "true"  OnSelectedIndexChanged ="ddAlmacen_SelectedIndexChanged"></asp:DropDownList>      
												</div>
											</div>
											<div class="6u 12u$(xsmall)">
												<div class="select-wrapper">
